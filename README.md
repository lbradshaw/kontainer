...
A self-hosted, cross-platform inventory management system for tracking items in storage containers, boxes, and totes. Features QR code labels, image galleries, a modern web interface, and mobile support via the [Kontainer Companion app](https://github.com/lbradshaw/kontainer_companion) for iOS and Android.
